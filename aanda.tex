...
\begin{figure}[h!]
  ...
  \caption{\label{Xco} Correlation between the molecular gas column density derived from dust and H\rmnum{1} emission, and the CO integrated intensity in Draco1. The black and blue lines are the best fitting models for the two regimes separated by the vertical black dotted line ($I_{CO}=2.5\: K.km.s^{-1}$).}
\end{figure}
