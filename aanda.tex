...
\end{figure*}
   ...
   In a second time, we computed position-velocity (PV) diagrams for the H\rmnum{1} and CO(1-0) emission in the different regions along the shock front.

   For region Draco2, we combuted PV diagrams along four slits: the vertical and horizontal directions, and the $\pm 45$\degree directions. The four PV diagrams show a good correlation between the CO and H\rmnum{1}
