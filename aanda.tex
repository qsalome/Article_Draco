...
Using the H\rmnum{1} observations, we aim to separate the warm and cold H\rmnum{1} phases. To do so, we first applied a coherent 
...
the resulting H\rmnum{1} integrated intensity map of the IVC. The black contours emphasised a rather good correlation between 
the H\rmnum{1} and dust emission.}
...
As said above, the high noise level of the DHIGLS data does not enable to recover the warm H\rmnum{1} phase. 
