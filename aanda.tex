...
%\begin{figure*}[h]
%  \centering
%  \includegraphics[page=1,height=8cm,trim=25 30 90 75,clip=true]{Figures/CO10_intensity.pdf}
%  \hspace{3mm}
%  \includegraphics[page=4,height=8cm,trim=195 30 260 75,clip=true]{Figures/CO10_intensity.pdf} \\
%  \includegraphics[page=2,height=8cm,trim=55 30 120 75,clip=true]{Figures/CO10_intensity.pdf}
%  \hspace{3mm}
%  \includegraphics[page=5,height=8cm,trim=165 30 230 75,clip=true]{Figures/CO10_intensity.pdf} \\
%  \includegraphics[page=3,height=8cm,trim=55 30 120 75,clip=true]{Figures/CO10_intensity.pdf}
%  \hspace{3mm}
%  \includegraphics[page=6,height=8cm,trim=215 30 280 75,clip=true]{Figures/CO10_intensity.pdf}
...
\end{figure*}
   ...
   In a second time, we looked at the position-velocity (PV) diagrams of both H\rmnum{1} and CO(1-0) emission at the shock front.
...
%\begin{figure*}[h!]
%  \centering
%  \includegraphics[page=2,width=0.48\linewidth,trim=30 90 50 145,clip=true]{Figures/PV_diagram_HI.pdf}
%  \hspace{3mm}
%  \includegraphics[page=3,width=0.48\linewidth,trim=30 90 55 110,clip=true]{Figures/PV_diagram_HI.pdf} \\
%  \includegraphics[page=2,width=0.48\linewidth,trim=30 90 50 145,clip=true]{Figures/PV_diagram_CO.pdf}
%  \hspace{3mm}
%  \includegraphics[page=3,width=0.48\linewidth,trim=30 90 55 110,clip=true]{Figures/PV_diagram_CO.pdf}
%  \caption{\label{PV-diag} Position-velocity diagrams of the H\rmnum{1} (\emph{top}) and CO (\emph{bottom}) in Draco4-6 (\emph{left}) and Draco2 (\emph{right}). The PV diagrams are centred in $\alpha=16^h 53^m 50.8^s$, $\delta=+$61:11:04.5 over a slit oriented along the shock front \textit{with a width of $8.5'$, to include all the region observed in CO}. They were computed at $1'$ and $0.8\: km.s^{-1}$ resolution.}
%\end{figure*}
%
%\begin{figure*}[h!]
%  \centering
%  \includegraphics[page=5,width=0.48\linewidth,trim=30 105 55 120,clip=true]{Figures/PV_diagram_HI.pdf}
%  \hspace{3mm}
%  \includegraphics[page=6,width=0.48\linewidth,trim=30 105 55 120,clip=true]{Figures/PV_diagram_HI.pdf} \\
%  \includegraphics[page=5,width=0.48\linewidth,trim=30 105 55 120,clip=true]{Figures/PV_diagram_CO.pdf}
%  \hspace{3mm}
%  \includegraphics[page=6,width=0.48\linewidth,trim=30 105 55 120,clip=true]{Figures/PV_diagram_CO.pdf}
%  \caption{\label{PV-diag} Position-velocity diagrams of the H\rmnum{1} (\emph{top}) and CO (\emph{bottom}) in Draco4-6 (\emph{left}) and Draco2 (\emph{right}). The PV diagrams are centred in $\alpha=16^h 53^m 50.8^s$, $\delta=+$61:11:04.5 over a slit oriented perpendicular to the shock front (\emph{right}) \textit{with a width of $8.5'$, to include all the region observed in CO}. They were computed at $1'$ and $0.8\: km.s^{-1}$ resolution.}
%\end{figure*}
...
%  \centering
  ...
  \hspace{3mm}
  \includegraphics[page=4,height=7cm,trim=205 10 200 40,clip=true]{Figures/PV_diagram_vertical.pdf} \\
  \includegraphics[page=4,width=7.7cm,trim=30 100 60 100,clip=true]{Figures/PV_diagram_horizontal.pdf}
  \caption{}
\end{figure*}
...
%  \centering
  ...
  \includegraphics[page=4,height=8cm,trim=320 85 325 80,clip=true]{Figures/CO10_intensity.pdf}
  \hspace{3mm}
  \includegraphics[page=5,height=8cm,trim=185 10 170 40,clip=true]{Figures/PV_diagram_vertical.pdf} \\
  \includegraphics[page=5,width=5.6cm,trim=85 40 110 40,clip=true]{Figures/PV_diagram_horizontal.pdf}
  \caption{}
\end{figure*}
...
%  \centering
  ...
  \includegraphics[page=5,height=8cm,trim=285 85 295 80,clip=true]{Figures/CO10_intensity.pdf}
  \hspace{3mm}
  \includegraphics[page=6,height=8cm,trim=200 10 185 40,clip=true]{Figures/PV_diagram_vertical.pdf} \\
  \includegraphics[page=6,width=6.5cm,trim=30 40 45 40,clip=true]{Figures/PV_diagram_horizontal.pdf}
  \caption{}
\end{figure*}
...
%  \centering
  ...
  \includegraphics[page=6,height=8.5cm,trim=335 85 342 80,clip=true]{Figures/CO10_intensity.pdf}
  \hspace{3mm}
  \includegraphics[page=7,height=8.5cm,trim=165 10 150 40,clip=true]{Figures/PV_diagram_vertical.pdf} \\
  \includegraphics[page=7,width=5.6cm,trim=125 40 150 40,clip=true]{Figures/PV_diagram_horizontal.pdf}
  \caption{}
\end{figure*}
...
%  \centering
  ...
  \includegraphics[width=9cm,trim=130 175 140 175,clip=true]{Figures/Draco2+9_rot_intensity.png}
  \hspace{3mm}
  \includegraphics[page=3,height=6cm,trim=233 10 220 40,clip=true]{Figures/PV_diagram_vertical.pdf} \\
