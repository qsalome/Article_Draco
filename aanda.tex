...
\begin{figure*}[h]
  \centering
  \includegraphics[page=1,width=0.49\linewidth,trim=0 0 0 0,clip=true]{Figures/Test_decomposition.pdf}
  \includegraphics[page=3,width=0.49\linewidth,trim=0 0 0 0,clip=true]{Figures/Test_decomposition.pdf}
